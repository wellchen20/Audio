...
public class WhiteBoardCell extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        initGesture();
        mWhiteboardPencil.setOnClickListener(new OnClickListener() {
            @Override
        ...
        mWhiteboardMarker.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        mWhiteboardEraser.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        mWhiteboardClearAll.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
